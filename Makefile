all: sr_main1 sr_main2 sr_main3 sr_main4
...
sr_main2:
	...
	find -name tempFile -print0 | xargs -0 -I file mv file ./last_tempFile
...
sr_main4:
	@echo " Compile sr_main4 ...";
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/sr_main4.c ./src/sort_file.c -lbf -o ./build/sr_main4 -O2
